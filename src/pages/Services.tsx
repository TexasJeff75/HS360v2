...
import { Dna, TestTube, Users, ChevronRight, Award, Microscope } from 'lucide-react';
  ...
  const services = [
    {
      ...
      subtitle: "Personalized SNP Panels",
      description: "Comprehensive genetic analysis to understand individual responses to nutrients and therapeutic interventions.",
      features: [
