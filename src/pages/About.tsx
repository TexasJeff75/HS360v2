...
const About = () => {
  ...
  const leadership = [
    ...
    },
    {
      ...
      background: "PhD in Biochemistry, pioneered therapeutics research at Stanford University"
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-cool-gray font-inter leading-relaxed">
              ...
              diagnostics, genetic insights, and cutting-edge science.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 font-inter leading-relaxed">
                  ...
                  and clinical laboratory services, we're transforming 
