...
import { ChevronRight, Dna, TestTube, Users, Award, ArrowRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Personalized SNP analysis panels for precision medicine.",
      link: "/services"
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl text-cool-gray font-inter mb-8 leading-relaxed">
                Integrating genetic insights and advanced laboratory testing 
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="font-inter">Cutting-edge genetic insights and advanced testing</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="bg-white/20 p-1 rounded-full">
                    <ChevronRight className="h-4 w-4" />
