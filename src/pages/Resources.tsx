...
const Resources = () => {
  ...
  const faqs = [
    {
      question: "What qualifications are required to order testing?",
      answer: "Testing is available exclusively to licensed healthcare practitioners including MDs, DOs, NPs, PharmDs, chiropractors, and certified wellness providers."
    },
    {
